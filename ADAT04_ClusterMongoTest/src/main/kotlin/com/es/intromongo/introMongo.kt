...
fun main() {
    ...
    // podemos realizar la conexión con el cluster
    ...
    // 3º Con la BD, podemos realizar las consultas a la coleccion que queramos
    val collection = bd.getCollection("documentoada")
